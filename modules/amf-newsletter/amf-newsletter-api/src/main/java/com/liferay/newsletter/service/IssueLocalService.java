...
public interface IssueLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.newsletter.service.impl.IssueLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the issue local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link IssueLocalServiceUtil} if injection and service tracking are not available.
	 */
